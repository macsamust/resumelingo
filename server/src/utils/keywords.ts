 ...
 * approach as ContentGenerator.ts and client/src/utils/atsCheck.ts's
 * extractKeywords(). Used by Resume.recruiterCard to derive the Recruiter
 * Mode candidate card's "skills" list from the resume's own generated
 * bullets and profession answers, rather than a separate field to fill in.
 */
