...
export const PROFESSIONS: ProfessionDefinition[] = [
  ...
  },
  {
    ...
    // the fields that are otherwise profession-specific: Certifications,
    // Skills, Years of Experience, Interests, and Additional Notes — all of
    // which show up under the "Answers" section like any other profession.
    key: "other",
    label: "Other",
    questions: [
