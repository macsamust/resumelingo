 ...
 * image (client/public/brand/parrot-logo-3.png, native 779x676px,
 ...
 * 779:676 aspect ratio, so passing `size` (treated as width) can't stretch
 * or distort it.
 *
 * Filename increments ("-2", "-3", ...) because the /public mount doesn't
 * allow overwriting a previously-written file in place — each image
 * update lands as a new file, with the previous one deleted separately.
 */
