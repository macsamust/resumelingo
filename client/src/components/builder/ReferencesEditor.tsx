 ...
 * with the candidate (e.g. "Former Manager", "Colleague"), and when they
 * worked with/observed the candidate. Same list-editor pattern as
 * AwardsEditor.tsx. Only ever shown when the "References" checkbox in
 * ResumeEditPage is on (see Resume.referencesEnabled) — off by default, and
 * Premium-subscriber-gated server-side regardless of what's sent here.
 */
    ...
    <div className="experience-editor">
      {references.map((entry, index) => (
        <div className="experience-row" key={index}>
          ...
          <MonthYearField
            label="Date observed"
            value={entry.dateObserved}
            onChange={(v) => updateEntry(index, { dateObserved: v })}
          />
