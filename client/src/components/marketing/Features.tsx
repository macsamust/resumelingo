const FEATURES = [
  ...
  { icon: "🎨", title: "20+ professional templates", body: "Executive, Modern, Government, Federal, Technical, Military Transition, Healthcare, Academic, and more. Preview instantly, no rebuilding." },
