...
const FALLBACK_PLANS: SubscriptionPlan[] = [
  ...
  { tier: "professional", name: "Professional", priceMonthly: 9.99, resumeLimit: 3, features: ["Three resumes", "Unlimited edits", "Template library", "Private sharing", "Analytics", "Resume scoring", "Career Center", "AI assistance", "Job application tracker"] },
  { tier: "premium", name: "Premium", priceMonthly: 19.99, resumeLimit: -1, features: ["Everything in Professional", "Unlimited resumes", "Premium templates", "Branded resume link", "Resume analytics", "Interview preparation", "Career coaching resources", "ATS optimization", "AI cover letters & thank-you letters", "Portfolio pages & personal branding tools"] },
];
