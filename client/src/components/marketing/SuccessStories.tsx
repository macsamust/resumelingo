...
export const STORIES = [
  { initial: "C", quote: "I landed a Senior Engineer position within weeks of sharing my ResumeLingo link.", name: "Chris R.", role: "Senior Engineer" },
    ...
    <section id="stories" className="stories-bg">
      <div className="wrap">
        <div className="section-head">
          ...
          <h2>Subscribers who put their ResumeLingo to work</h2>
        </div>
