    ...
    <section id="value">
      <div className="wrap">
        <div className="section-head">
          <span className="section-tag">Why Websume</span>
        ...
        <div className="link-grid">
          <div className="link-card">
            ...
            <p className="link-url">websume.com/john-smith</p>
          ...
          <div className="link-card">
            ...
            <p className="link-url">websume.com/racheljohnson/projectmanager</p>
          ...
          <div className="link-card">
            ...
            <p className="link-url">websume.com/profile/8A62FD</p>
            <p className="link-desc">A password-protected or one-time link shared only with the people you choose.</p>
          </div>
        </div>
        <p className="value-note">Update your Websume once, and everyone who has the link automatically sees the latest version.</p>
      </div>
    </section>
  );
}
