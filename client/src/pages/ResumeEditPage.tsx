        ...
        <div className="builder-panel builder-panel-with-fab">
          ...
          <div className="builder-progress" style={{ marginTop: 12 }}>
            <div className="builder-progress-label">
              ...
              {/* "key sections" — see New Resume's identical fraction for
                  why (ResumeBuilderPage.tsx, Sep 2026 UX review, UX-09):
                  this page has even more numbered/named sections than New
                  Resume, but the denominator only ever counts the handful
                  that meaningfully affect the generated resume (see
                  sectionProgress's doc comment above). Bare "sections" read
                  as broken arithmetic; "required sections" (tried first,
                  then rejected — CJ, Sep 2026) overstated it, since nothing
                  here blocks saving on this count being incomplete. "Key"
                  says these are the ones that matter without claiming
          ...
          <CollapsibleSection title="Languages" forceOpen={forceOpen}>
            <p className="hero-note" style={{ marginBottom: 16 }}>
          ...
          <CollapsibleSection title="Generated Summary & Bullets" forceOpen={forceOpen}>
            <p className="hero-note" style={{ marginBottom: 16 }}>
              Your Objective/Summary/Profile text and top bullets are written by Poly from your profession, answers,
          ...
          {isPremium && selectedTemplateIsPremium && (
            <CollapsibleSection title="Cover Letter" forceOpen={forceOpen}>
              <p className="hero-note" style={{ marginBottom: 16 }}>
                Has Poly write a tailored cover letter alongside this resume. Off by default, turn this on to have one
                ...
                <>
                  {resume.coverLetterEnabled && resume.generatedCoverLetter ? (
                    ...
                    <p className="hero-note" style={{ marginTop: 16 }}>
                      Your cover letter, written by Poly, will appear here after you save.
                    </p>
                  )}
