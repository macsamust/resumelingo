...
export const DEFAULT_ROLE_DESCRIPTIONS: RoleDescription[] = [
  ...
  },
  {
    ...
    keyTraits: ["adaptability", "initiative", "strong followthrough"],
  },
  {
  ...
  },
  {
    ...
    keyTraits: ["organization", "adaptability", "steady followthrough under shifting priorities"],
  },
  {
    keywords: [],
    ...
    keyTraits: ["attention to detail", "integrity", "dependable followthrough"],
  },
  {
    keywords: [],
